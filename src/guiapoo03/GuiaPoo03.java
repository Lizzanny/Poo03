...
public class GuiaPoo03 {
    ...
    public static void main(String[] args) {
        ...
        nums.crearOperacion();
        System.out.println("La suma es:"+nums.sumar());
        System.out.println("La resta es:"+nums.restar());
        System.out.println("La multiplicación es:"+nums.multiplicar());
        System.out.printf("La división es:%.3f%n",nums.dividir());
    }
